...
// ciudadano/a. `day` = sueldo base por día a prosperidad 1.0 (el sueldo real se
// escala por la prosperidad del pueblo); `taxPct` = % de impuesto mensual que se
// le descuenta y va al pote nacional (EE.UU.). Mes ≈ day × 30.
export const PROFESSIONS = [
  { label: '⚾ Pelotero/a', day: 130, taxPct: 30 },
  { label: '🩺 Médico/a', day: 120, taxPct: 30 },
  { label: '🦷 Dentista', day: 110, taxPct: 28 },
  { label: '✈️ Piloto', day: 105, taxPct: 28 },
  { label: '⚖️ Abogado/a', day: 100, taxPct: 28 },
  { label: '🏗️ Ingeniero/a', day: 95, taxPct: 26 },
  { label: '🔬 Científico/a', day: 90, taxPct: 26 },
  { label: '🧑‍💻 Programador/a', day: 90, taxPct: 26 },
  { label: '💊 Farmacéutico/a', day: 85, taxPct: 25 },
  { label: '🐄 Veterinario/a', day: 80, taxPct: 24 },
  { label: '💼 Contable', day: 72, taxPct: 24 },
  { label: '👩‍⚕️ Enfermero/a', day: 60, taxPct: 20 },
  { label: '🛒 Comerciante', day: 58, taxPct: 18 },
  { label: '👮 Policía', day: 55, taxPct: 18 },
  { label: '🚒 Bombero/a', day: 55, taxPct: 18 },
  { label: '🧑‍🚒 Rescatista', day: 52, taxPct: 18 },
  { label: '👨‍🍳 Chef', day: 52, taxPct: 18 },
  { label: '⚡ Electricista', day: 50, taxPct: 16 },
  { label: '🔧 Plomero/a', day: 50, taxPct: 16 },
  { label: '📰 Periodista', day: 50, taxPct: 16 },
  { label: '🧑‍🔧 Mecánico/a', day: 48, taxPct: 16 },
  { label: '🧑‍🏫 Maestro/a', day: 48, taxPct: 15 },
  { label: '🎸 Músico/a', day: 46, taxPct: 15 },
  { label: '🔨 Carpintero/a', day: 45, taxPct: 15 },
  { label: '⛵ Marinero/a', day: 44, taxPct: 14 },
  { label: '📚 Bibliotecario/a', day: 44, taxPct: 14 },
  { label: '🧱 Albañil', day: 42, taxPct: 14 },
  { label: '💇 Estilista', day: 42, taxPct: 14 },
  { label: '🎨 Artista', day: 42, taxPct: 14 },
  { label: '💈 Barbero/a', day: 40, taxPct: 12 },
  { label: '🚕 Taxista', day: 40, taxPct: 12 },
  { label: '🚌 Chofer de guagua', day: 40, taxPct: 12 },
  { label: '🧑‍🎨 Artesano/a', day: 38, taxPct: 12 },
  { label: '🍞 Panadero/a', day: 38, taxPct: 12 },
  { label: '🧺 Costurero/a', day: 36, taxPct: 10 },
  { label: '🛵 Mensajero/a', day: 35, taxPct: 10 },
  { label: '🎣 Pescador/a', day: 34, taxPct: 10 },
  { label: '🐔 Avicultor/a', day: 32, taxPct: 10 },
  { label: '☕ Cafetalero/a', day: 32, taxPct: 10 },
  { label: '🍌 Agricultor/a', day: 30, taxPct: 10 },
  { label: '🌱 Jardinero/a', day: 30, taxPct: 8 },
  { label: '🧂 Salinero/a', day: 28, taxPct: 8 },
  { label: '🧹 Conserje', day: 28, taxPct: 8 },
  { label: '🍧 Piragüero/a', day: 26, taxPct: 8 },
];
